...
type InterfaceIdentifier struct {
	...
	LinkId   *int32  `protobuf:"varint,2,req,name=link_id,json=linkId" json:"link_id,omitempty"`
}
...
func (x *InterfaceIdentifier) GetHostname() string {
...
func (x *InterfaceIdentifier) GetLinkId() int32 {
...
var file_core_base_proto_rawDesc = []byte{
	...
	0x6d, 0x74, 0x69, 0x64, 0x22, 0x4a, 0x0a, 0x13, 0x49, 0x6e, 0x74, 0x65, 0x72, 0x66, 0x61, 0x63,
	0x65, 0x49, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x66, 0x69, 0x65, 0x72, 0x12, 0x1a, 0x0a, 0x08, 0x68,
	0x6f, 0x73, 0x74, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x01, 0x20, 0x02, 0x28, 0x09, 0x52, 0x08, 0x68,
	0x6f, 0x73, 0x74, 0x6e, 0x61, 0x6d, 0x65, 0x12, 0x17, 0x0a, 0x07, 0x6c, 0x69, 0x6e, 0x6b, 0x5f,
	0x69, 0x64, 0x18, 0x02, 0x20, 0x02, 0x28, 0x05, 0x52, 0x06, 0x6c, 0x69, 0x6e, 0x6b, 0x49, 0x64,
...
var file_core_base_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_core_base_proto_goTypes = []interface{}{
	(*MultiTopologyIdentifier)(nil), // 0: jagw.MultiTopologyIdentifier
	(*InterfaceIdentifier)(nil),     // 1: jagw.InterfaceIdentifier
}
...
func file_core_base_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_core_base_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
